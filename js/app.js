...
(function () {
  ...
  const translations = {
    vi: {
      ...
      'nav.contact': 'Liên hệ',
      'nav.status': 'Sẵn sàng nhận việc (Full-time / On-site / Remote)',
      ...
      'contact.location.value': 'Sapa / Hồ Chí Minh (On-site / Di chuyển)',
    ...
    en: {
      ...
      'nav.contact': 'Contact',
      'nav.status': 'Available for work (Full-time / On-site / Remote)',
      'hero.badge': 'Operations · Automation · AI Integration',
      ...
      'contact.location.value': 'Sapa / Ho Chi Minh City (On-site / Travel-ready)',
